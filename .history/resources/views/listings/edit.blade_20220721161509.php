...
@section('content')
    <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-5">
        ...
        <form method="POST" action="/listings/{{ $listing->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
                    value="{{ $listing->description }}" placeholder="Include tasks, requirements, salary, etc">$listing->description</textarea>
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
